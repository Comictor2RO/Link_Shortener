  ...
  return (
    <div>
      <label className="swap swap-rotate">
          ...
          {/* Soare - tema light */}
          <svg
              className="swap-off fill-current h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 lg:h-9 lg:w-9 xl:h-10 xl:w-10"
          ...
          {/* Lună - tema dark */}
          <svg
              className="swap-on fill-current h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 lg:h-9 lg:w-9 xl:h-10 xl:w-10"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24">
                  <path
